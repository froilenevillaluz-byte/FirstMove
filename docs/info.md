...
Hold reset low then release it (rst_n) with the clock running.
Set ui_in[1:0] to your move: 01 for Rock, 10 for Paper, 11 for Scissors.
Pulse ui_in[2] high for at least one clock cycle, then back low, to submit your move.
Read the result:
...
Repeat from step 2 for another round; the counts persist until reset.
